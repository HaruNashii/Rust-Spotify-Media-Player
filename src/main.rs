...
fn volume_icon() -> (bool, bool, bool, bool, Rect) {
...
fn buttons() -> (Rect, Rect, Rect, Rect) {
    ...
    (previous_rect, pause_rect, next_rect, shuffle_button_rect)
}


fn fonts(texture_creator: &TextureCreator<WindowContext>) -> (Vec<Texture>, Vec<Rect>) {
